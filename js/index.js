(function() {
  ...
  var DownloadButton = React.createClass({
    render: function() {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: props.arch === "ia32" ? "d32bit" : "d64bit" }, /* @__PURE__ */ React.createElement("a", { href: url }, props.version, /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("strong", null, props.flavor.toUpperCase())));
    }
  });
  var DownloadArea = React.createClass({
    render: function() {
      ...
      var btnList = this.props.flavors.filter(function(flavor) {
        ...
        return /* @__PURE__ */ React.createElement(DownloadButton, { key: i, os: props.os, base: props.base, arch: props.arch, version: props.version, flavor: flavor });
      });
      var use = props.use.charAt(0).toUpperCase() + props.use.substring(1);
      var version = props.version;
      if (version === "v0.17.0") version = "0.17.0";
      return /* @__PURE__ */ React.createElement("div", { className: "os" }, /* @__PURE__ */ React.createElement("h1", null, "Download ", /* @__PURE__ */ React.createElement("em", null, use), " for ", os2name[props.os], " (", props.arch, ")"), /* @__PURE__ */ React.createElement("div", null, "Chromium ", props.components.chromium.split(".")[0], " + Node ", props.components.node), /* @__PURE__ */ React.createElement("div", { className: "dlbtnlist" }, btnList), /* @__PURE__ */ React.createElement("a", { className: "release-notes", href: "/blog/" + version + "/" }, "Release Notes"));
    }
  });
  function render(downAreaElem, versions) {
    ...
    if (idx >= 0) {
      ...
      ReactDOM.render(
        /* @__PURE__ */ React.createElement(DownloadArea, { use: use, files: versions.versions[idx].files, flavors: flavors, version: version, os: os, arch: arch, base: baseUrl, components: versions.versions[idx].components }),
        downAreaElem
      );
    }
  }
